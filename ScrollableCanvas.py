...
from Row import Row
from PathToImage import batchResize, rests, barlines
...
class ScrollableCanvas(tk.Frame):
    ...
    activeNode = None
    notes = {
        'assets/notes/breve.png':              ['assets/heads/breve.png', None],
        'assets/notes/whole note.png':         ['assets/heads/whole note.png', None],
        'assets/notes/half note.png':          ['assets/heads/unfilled.png', 'assets/tails/untailed.png'],
        'assets/notes/quarter note.png':       ['assets/heads/filled.png', 'assets/tails/untailed.png'],
        'assets/notes/eighth note.png':        ['assets/heads/filled.png', 'assets/tails/eighth tail.png'],
        'assets/notes/sixteenth note.png':     ['assets/heads/filled.png', 'assets/tails/sixteenth tail.png'],
        'assets/notes/thirty-second note.png': ['assets/heads/filled.png', 'assets/tails/thirty-second tail.png'],
        'assets/notes/sixty-fourth note.png':  ['assets/heads/filled.png', 'assets/tails/sixty-fourth tail.png'],
        'assets/notes/one hundred twenty-eighth note.png': ['assets/heads/filled.png', 'assets/tails/one hundred twenty-eighth tail.png']
    }
    ...
    def __init__(self, root, panel):
        ...
        root.bind("<Return>", self.delete)  # change to "<Button-3>" later
